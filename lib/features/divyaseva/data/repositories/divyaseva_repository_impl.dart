...
class MockBookingRepository implements DivyaSevaRepository {
  const MockBookingRepository(this._datasource);
  ...
  Future<List<PrepItem>> getPreparationChecklist() =>
      _datasource.getPreparationChecklist();
  ...
  Future<List<BookingStep>> getTrackingSteps() =>
      _datasource.getTrackingSteps();

  @override
  Future<List<FamilyMember>> getFamilyMembers() =>
      _datasource.getFamilyMembers();
  ...
  Future<PartnerDashboard> getPartnerDashboard() =>
      _datasource.getPartnerDashboard();
}

class DivyaSevaRepositoryImpl extends MockBookingRepository {
  const DivyaSevaRepositoryImpl(super.datasource);
}
